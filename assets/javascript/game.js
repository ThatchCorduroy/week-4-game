$(document).ready(function() {
    ...
    function initialize () {
        ...
        $("#character1").data("attr", {name: "Obi-Wan Kenobi", hp: 120, ap: 8, bap: 8, cap: 30})
        $("#character2").data("attr", {name: "Luke Skywalker", hp: 100, ap: 20, bap: 20, cap: 5})
        $("#character3").data("attr", {name: "Darth Sidious", hp: 150, ap: 10, bap: 10, cap: 20})
        $("#character4").data("attr", {name: "Darth Maul", hp: 180, ap: 5, bap: 5, cap: 25})
...
//reset
    $(document).on("click", "#reset", function () {
        ...
        $("#characters").children().removeClass("enemy enemies").addClass("character").show();
